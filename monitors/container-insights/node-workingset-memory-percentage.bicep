...
param alertDescription string = 'alert of node working set memory percentage'
...
module metric 'metric-alert.bicep' = {
  name: 'apply-node-workingset-memory-metric-for-${aksClusterName}'
  params: {
    alertName: alertName
