...
param alertDescription string = 'alert of container working set memory percentage'
...
module metric 'metric-alert.bicep' = {
  name: 'apply-container-workingset-memory-metric-for-${aksClusterName}'
  params: {
    alertName: alertName
