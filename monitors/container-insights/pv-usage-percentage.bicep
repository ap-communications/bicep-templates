...
param alertDescription string = 'alert of persistent volume usage percentage'
...
module metric 'metric-alert.bicep' = {
  name: 'apply-pv-usage-metric-for-${aksClusterName}'
  params: {
    alertName: alertName
    ...
    metricNamespace: 'persistentvolumes'
    dimensions: [
      {
